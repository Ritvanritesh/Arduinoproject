...
public class arduino_sensor extends PApplet {
...
public void drawText() { // draws the texts on the screen
  ...
  textSize(40);
  text("Ritvan", width-width*0.970f, height-height*0.0277f);
  text("Angle: " + iAngle +" °", width-width*0.78f, height-height*0.0277f);
  text("Distance: ", width-width*0.46f, height-height*0.0277f);
  if(iDistance<40) {
  ...
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "arduino_sensor" };
    if (passedArgs != null) {
